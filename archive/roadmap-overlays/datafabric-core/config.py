"""
Конфигурация для datafabric-core
"""
...
class DatafabricCoreConfig(BaseSettings):
    """Конфигурация datafabric-core"""
    
    # Основные настройки
    system_name: str = Field(default="datafabric-core", description="Имя системы")
    ...
    # Специфичные настройки для datafabric-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "DATAFABRIC_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = DatafabricCoreConfig()
