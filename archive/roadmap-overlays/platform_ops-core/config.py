"""
Специализированная конфигурация для platform_ops-core
...
class PlatformOpsCoreConfig(BaseSettings):
    """Конфигурация platform_ops-core"""
    
    # Основные настройки
    system_name: str = Field(default="platform_ops-core", description="Имя системы")
    ...
    # Operations специфичные настройки
    # TODO: Добавить настройки специфичные для Operations
    custom_setting: str = Field(default="default_value", description="Пример настройки")

    
    class Config:
        env_file = ".env"
        env_prefix = "PLATFORM_OPS_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = PlatformOpsCoreConfig()
