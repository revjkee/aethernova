"""
ЭКСТРЕННАЯ конфигурация для compliance-core
...
class ComplianceCoreEmergencyConfig(BaseSettings):
    """ЭКСТРЕННАЯ конфигурация compliance-core"""
    
    # Основные настройки
    system_name: str = Field(default="compliance-core", description="Имя системы")
    ...
    class Config:
        ...
        env_prefix = "COMPLIANCE_CORE_EMERGENCY_"
        case_sensitive = False

# Глобальный экземпляр ЭКСТРЕННОЙ конфигурации
config = ComplianceCoreEmergencyConfig()
