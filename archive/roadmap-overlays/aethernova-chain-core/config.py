"""
ЭКСТРЕННАЯ конфигурация для aethernova-chain-core
...
class AethernovaChainCoreEmergencyConfig(BaseSettings):
    """ЭКСТРЕННАЯ конфигурация aethernova-chain-core"""
    
    # Основные настройки
    system_name: str = Field(default="aethernova-chain-core", description="Имя системы")
    ...
    class Config:
        ...
        env_prefix = "AETHERNOVA_CHAIN_CORE_EMERGENCY_"
        case_sensitive = False

# Глобальный экземпляр ЭКСТРЕННОЙ конфигурации
config = AethernovaChainCoreEmergencyConfig()
