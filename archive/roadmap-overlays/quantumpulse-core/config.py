"""
ЭКСТРЕННАЯ конфигурация для quantumpulse-core
...
class QuantumpulseCoreEmergencyConfig(BaseSettings):
    """ЭКСТРЕННАЯ конфигурация quantumpulse-core"""
    
    # Основные настройки
    system_name: str = Field(default="quantumpulse-core", description="Имя системы")
    ...
    class Config:
        ...
        env_prefix = "QUANTUMPULSE_CORE_EMERGENCY_"
        case_sensitive = False

# Глобальный экземпляр ЭКСТРЕННОЙ конфигурации
config = QuantumpulseCoreEmergencyConfig()
