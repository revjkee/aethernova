"""
Конфигурация для chronowatch-core
"""
...
class ChronowatchCoreConfig(BaseSettings):
    """Конфигурация chronowatch-core"""
    
    # Основные настройки
    system_name: str = Field(default="chronowatch-core", description="Имя системы")
    ...
    # Специфичные настройки для chronowatch-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "CHRONOWATCH_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = ChronowatchCoreConfig()
