"""
Конфигурация для oblivionvault-core
"""
...
class OblivionvaultCoreConfig(BaseSettings):
    """Конфигурация oblivionvault-core"""
    
    # Основные настройки
    system_name: str = Field(default="oblivionvault-core", description="Имя системы")
    ...
    # Специфичные настройки для oblivionvault-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "OBLIVIONVAULT_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = OblivionvaultCoreConfig()
