# Evolution Core Core System

Evolution Core - это ключевой компонент экосистемы AetherNova, предоставляющий функциональность evolution core.
...
```python
from evolution_core.config import config
...
### Программный запуск
```python
from evolution_core import EvolutioncoreCore
...
# Запуск с покрытием
pytest tests/ --cov=evolution_core
```
