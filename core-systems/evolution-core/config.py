"""
Специализированная конфигурация для evolution-core
...
class EvolutionCoreConfig(BaseSettings):
    """Конфигурация evolution-core"""
    
    # Основные настройки
    system_name: str = Field(default="evolution-core", description="Имя системы")
    ...
    # System Evolution специфичные настройки
    # TODO: Добавить настройки специфичные для System Evolution
    custom_setting: str = Field(default="default_value", description="Пример настройки")

    
    class Config:
        env_file = ".env"
        env_prefix = "EVOLUTION_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = EvolutionCoreConfig()
