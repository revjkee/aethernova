"""
Конфигурация для neuroforge-core
"""
...
class NeuroforgeCoreConfig(BaseSettings):
    """Конфигурация neuroforge-core"""
    
    # Основные настройки
    system_name: str = Field(default="neuroforge-core", description="Имя системы")
    ...
    # Специфичные настройки для neuroforge-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "NEUROFORGE_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = NeuroforgeCoreConfig()
