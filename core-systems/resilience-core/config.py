"""
Конфигурация для resilience-core
"""
...
class ResilienceCoreConfig(BaseSettings):
    """Конфигурация resilience-core"""
    
    # Основные настройки
    system_name: str = Field(default="resilience-core", description="Имя системы")
    ...
    # Специфичные настройки для resilience-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "RESILIENCE_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = ResilienceCoreConfig()
