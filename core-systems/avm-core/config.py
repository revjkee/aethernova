"""
Специализированная конфигурация для avm-core
...
class AvmCoreConfig(BaseSettings):
    """Конфигурация avm-core"""
    
    # Основные настройки
    system_name: str = Field(default="avm-core", description="Имя системы")
    ...
    # Runtime Environment специфичные настройки
    # TODO: Добавить настройки специфичные для Runtime Environment
    custom_setting: str = Field(default="default_value", description="Пример настройки")

    
    class Config:
        env_file = ".env"
        env_prefix = "AVM_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = AvmCoreConfig()
