"""
Специализированная конфигурация для onchain-core
...
class OnchainCoreConfig(BaseSettings):
    """Конфигурация onchain-core"""
    
    # Основные настройки
    system_name: str = Field(default="onchain-core", description="Имя системы")
    ...
    # Blockchain специфичные настройки
    # TODO: Добавить настройки специфичные для Blockchain
    custom_setting: str = Field(default="default_value", description="Пример настройки")

    
    class Config:
        env_file = ".env"
        env_prefix = "ONCHAIN_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = OnchainCoreConfig()
