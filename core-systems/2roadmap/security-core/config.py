"""
Конфигурация для security-core
"""
...
class SecurityCoreConfig(BaseSettings):
    """Конфигурация security-core"""
    
    # Основные настройки
    system_name: str = Field(default="security-core", description="Имя системы")
    ...
    # Специфичные настройки для security-core
