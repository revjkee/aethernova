"""
Специализированная конфигурация для silentlink-core
...
class SilentlinkCoreConfig(BaseSettings):
    """Конфигурация silentlink-core"""
    
    # Основные настройки
    system_name: str = Field(default="silentlink-core", description="Имя системы")
    ...
    # Covert Communication специфичные настройки
    # TODO: Добавить настройки специфичные для Covert Communication
    custom_setting: str = Field(default="default_value", description="Пример настройки")

    
    class Config:
        env_file = ".env"
        env_prefix = "SILENTLINK_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = SilentlinkCoreConfig()
