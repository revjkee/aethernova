"""
Специализированная конфигурация для forgemind-core
...
class ForgemindCoreConfig(BaseSettings):
    """Конфигурация forgemind-core"""
    
    # Основные настройки
    system_name: str = Field(default="forgemind-core", description="Имя системы")
    ...
    # Content Generation специфичные настройки
    # TODO: Добавить настройки специфичные для Content Generation
    custom_setting: str = Field(default="default_value", description="Пример настройки")

    
    class Config:
        env_file = ".env"
        env_prefix = "FORGEMIND_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = ForgemindCoreConfig()
