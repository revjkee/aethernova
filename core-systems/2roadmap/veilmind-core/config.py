"""
Конфигурация для veilmind-core
"""
...
class VeilmindCoreConfig(BaseSettings):
    """Конфигурация veilmind-core"""
    
    # Основные настройки
    system_name: str = Field(default="veilmind-core", description="Имя системы")
    ...
    # Специфичные настройки для veilmind-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "VEILMIND_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = VeilmindCoreConfig()
