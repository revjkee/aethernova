"""
Конфигурация для omnimind-core
"""
...
class OmnimindCoreConfig(BaseSettings):
    """Конфигурация omnimind-core"""
    
    # Основные настройки
    system_name: str = Field(default="omnimind-core", description="Имя системы")
    ...
    # Специфичные настройки для omnimind-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "OMNIMIND_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = OmnimindCoreConfig()
