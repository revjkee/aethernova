"""
Специализированная конфигурация для graph-core
...
class GraphCoreConfig(BaseSettings):
    """Конфигурация graph-core"""
    
    # Основные настройки
    system_name: str = Field(default="graph-core", description="Имя системы")
    ...
    # Data Structures специфичные настройки
    # TODO: Добавить настройки специфичные для Data Structures
    custom_setting: str = Field(default="default_value", description="Пример настройки")

    
    class Config:
        env_file = ".env"
        env_prefix = "GRAPH_CORE_"
