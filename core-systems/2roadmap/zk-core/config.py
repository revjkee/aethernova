"""
Специализированная конфигурация для zk-core
...
class ZkCoreConfig(BaseSettings):
    """Конфигурация zk-core"""
    
    # Основные настройки
    system_name: str = Field(default="zk-core", description="Имя системы")
    ...
    # Cryptography специфичные настройки
    # TODO: Добавить настройки специфичные для Cryptography
