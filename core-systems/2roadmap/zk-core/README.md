...
Zk Core - это ключевой компонент экосистемы AetherNova, предоставляющий функциональность zk core.
...
```python
from zk_core.config import config
...
### Программный запуск
```python
from zk_core import ZkcoreCore
