"""
Конфигурация для cybersecurity-core
"""
...
class CybersecurityCoreConfig(BaseSettings):
    """Конфигурация cybersecurity-core"""
    
    # Основные настройки
    system_name: str = Field(default="cybersecurity-core", description="Имя системы")
    ...
    # Специфичные настройки для cybersecurity-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "CYBERSECURITY_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = CybersecurityCoreConfig()
