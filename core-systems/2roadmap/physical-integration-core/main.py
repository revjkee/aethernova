"""
Основной модуль physical-integration-core
"""
...
class PhysicalIntegrationCoreCore:
    """Основной класс physical-integration-core"""
    ...
    def __init__(self):
        ...
        logger.configure(
            handlers=[
                {
                    "sink": "logs/physical-integration-core.log",
