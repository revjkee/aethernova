# Genius Core Core System

Genius Core - это ключевой компонент экосистемы AetherNova, предоставляющий функциональность genius core.
...
```python
from genius_core.config import config
...
### Программный запуск
```python
from genius_core import GeniuscoreCore
