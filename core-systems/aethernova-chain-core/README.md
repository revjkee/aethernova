# Aethernova Chain Core Core System

Aethernova Chain Core - это ключевой компонент экосистемы AetherNova, предоставляющий функциональность aethernova chain core.
...
```python
from aethernova_chain_core.config import config
...
### Программный запуск
```python
from aethernova_chain_core import AethernovachaincoreCore
...
# Запуск с покрытием
pytest tests/ --cov=aethernova_chain_core
```
