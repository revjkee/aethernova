...
class PolicyCoreConfig(BaseSettings):
    """Конфигурация policy-core"""
    
    # Основные настройки
    system_name: str = Field(default="policy-core", description="Имя системы")
    ...
    # Специфичные настройки для policy-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "POLICY_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = PolicyCoreConfig()
