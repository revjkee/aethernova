"""
Конфигурация для physical-integration-core
"""
...
class PhysicalIntegrationCoreConfig(BaseSettings):
    """Конфигурация physical-integration-core"""
    
    # Основные настройки
    system_name: str = Field(default="physical-integration-core", description="Имя системы")
    ...
    # Специфичные настройки для physical-integration-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "PHYSICAL_INTEGRATION_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = PhysicalIntegrationCoreConfig()
