# Offensive Security Core Core System

Offensive Security Core - это ключевой компонент экосистемы AetherNova, предоставляющий функциональность offensive security core.
...
```python
from offensive_security_core.config import config
...
### Программный запуск
```python
from offensive_security_core import OffensivesecuritycoreCore
...
# Запуск с покрытием
pytest tests/ --cov=offensive_security_core
```
