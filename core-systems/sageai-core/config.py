"""
ЭКСТРЕННАЯ конфигурация для sageai-core
...
class SageaiCoreEmergencyConfig(BaseSettings):
    """ЭКСТРЕННАЯ конфигурация sageai-core"""
    
    # Основные настройки
    system_name: str = Field(default="sageai-core", description="Имя системы")
    ...
    # ЭКСТРЕННЫЕ Advanced AI настройки
    ...
    class Config:
        ...
        env_prefix = "SAGEAI_CORE_EMERGENCY_"
        case_sensitive = False

# Глобальный экземпляр ЭКСТРЕННОЙ конфигурации
config = SageaiCoreEmergencyConfig()
