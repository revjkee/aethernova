# Sageai Core Core System

Sageai Core - это ключевой компонент экосистемы AetherNova, предоставляющий функциональность sageai core.
...
```python
from sageai_core.config import config
...
### Программный запуск
```python
from sageai_core import SageaicoreCore
