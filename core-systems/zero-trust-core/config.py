"""
Конфигурация для zero-trust-core
"""
...
class ZeroTrustCoreConfig(BaseSettings):
    """Конфигурация zero-trust-core"""
    
    # Основные настройки
    system_name: str = Field(default="zero-trust-core", description="Имя системы")
    ...
    # Специфичные настройки для zero-trust-core
    # TODO: Добавить специфичные настройки
    
    class Config:
        env_file = ".env"
        env_prefix = "ZERO_TRUST_CORE_"
        case_sensitive = False

# Глобальный экземпляр конфигурации
config = ZeroTrustCoreConfig()
