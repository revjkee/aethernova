# Graph Core Core System

Graph Core - это ключевой компонент экосистемы AetherNova, предоставляющий функциональность graph core.
...
```python
from graph_core.config import config
...
### Программный запуск
```python
from graph_core import GraphcoreCore
