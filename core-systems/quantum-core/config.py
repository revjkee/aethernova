"""
ЭКСТРЕННАЯ конфигурация для quantum-core
...
class QuantumCoreEmergencyConfig(BaseSettings):
    """ЭКСТРЕННАЯ конфигурация quantum-core"""
    
    # Основные настройки
    system_name: str = Field(default="quantum-core", description="Имя системы")
    ...
    class Config:
        ...
        env_prefix = "QUANTUM_CORE_EMERGENCY_"
        case_sensitive = False

# Глобальный экземпляр ЭКСТРЕННОЙ конфигурации
config = QuantumCoreEmergencyConfig()
