# Quantum Core Core System

Quantum Core - это ключевой компонент экосистемы AetherNova, предоставляющий функциональность quantum core.
...
```python
from quantum_core.config import config
...
### Программный запуск
```python
from quantum_core import QuantumcoreCore
